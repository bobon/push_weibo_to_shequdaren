...
date +"%x %X %N  %s"
echo "zhao直隶"
t=$(curl -sS -k 'https://api.m.jd.com/api?appid=interCenter_shopSign&t=1609858933000&loginType=2&functionId=interact_center_shopSign_signCollectGift&body=\{%22token%22:%224D24D6402AC5C4ABF676A6CE5C876AA7%22,%22activityId%22:10231300,%22venderId%22:1000117003,%22pageNumber%22:1,%22pageSize%22:20\}&jsonp=jsonp1004' \
