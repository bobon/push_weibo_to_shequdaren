...
date +"%x %X %N  %s"
echo "zhao橙影京东自营旗舰店"
t=$(curl -sS -k 'https://api.m.jd.com/api?appid=interCenter_shopSign&t=1609588867000&loginType=2&functionId=interact_center_shopSign_signCollectGift&body=\{%22token%22:%22FEC0244D748F99A452C9E37B8944D2D3%22,%22venderId%22:1000332147,%22activityId%22:10238175,%22type%22:56,%22actionType%22:7\}&jsonp=jsonp1004' \
